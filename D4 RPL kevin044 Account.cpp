...
int main()
{
	...
	cout << "credit dari  ACCOUNT 1 : Rp. 5000 ,-" << endl;
	cout << "credit dari  ACCOUNT 2 : Rp. 2500 ,-" << endl;
	...
	cout << "Saldo akhri dari ACCOUNT 1 : Rp. "<< Account1.getAccountBalance() <<",-"<< endl;
	cout << "Saldo akhri dari ACCOUNT 2 : Rp. "<< Account2.getAccountBalance() <<",-"<< endl;
